# React Developer Curriculum: Junior to Lead

A comprehensive learning path for React developers progressing from junior to lead-level positions.

## Overview

This curriculum covers both **technical React skills** and **leadership competencies** through a linear progression across four levels. Each level builds on the previous, with clear milestones marking your growth.
...
1. **Assess your current level** - Read each level's README to understand where you are
2. **Work through modules sequentially** - Each builds on previous knowledge
3. **Practice with real projects** - Apply concepts to your daily work
4. **Track your progress** - Check off completed modules
5. **Move up when ready** - Complete the milestone before advancing
...
- [API Design and Integration](02-mid-level/05-api-design-integration.md)
- [Error Handling Patterns](02-mid-level/06-error-handling-patterns.md)
- [Internationalization (i18n)](02-mid-level/07-internationalization.md)
...
- [End-to-End Testing with Playwright](02-mid-level/13-e2e-testing-with-playwright.md)
...
- [Architecture Decision Records (ADRs)](03-senior/02-architecture-decision-records.md)
...
- [Observability and Monitoring](03-senior/11-observability-monitoring.md)
...
- [Architecture Ownership](04-lead/02-architecture-ownership.md)
- [Team Processes](04-lead/03-team-processes.md)
- [Hiring and Onboarding](04-lead/04-hiring-onboarding.md)
- [Stakeholder Communication](04-lead/05-stakeholder-communication.md)
- [Technical Strategy](04-lead/06-technical-strategy.md)
- [Incident Management](04-lead/07-incident-management.md)
- [Documentation Culture](04-lead/08-documentation-culture.md)
- [Cross-Team Collaboration](04-lead/09-cross-team-collaboration.md)
- [Effective 1:1s](04-lead/10-effective-one-on-ones.md)
- [Conflict Resolution](04-lead/11-conflict-resolution.md)
- [Influence Without Authority](04-lead/12-influence-without-authority.md)

## Prerequisites

This curriculum assumes you are a **working junior React developer** with:
- Basic HTML, CSS, and JavaScript knowledge
- Some React experience (built basic apps)
- Familiarity with npm/yarn and modern JS tooling

## Contributing

Found an error or want to suggest improvements? Open an issue or submit a PR.
